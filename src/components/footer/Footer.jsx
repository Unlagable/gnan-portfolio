...
const Footer = () => {
    ...
    return (
      <div className="footer h-auto mx-5  bg-white dark:bg-neutral-900 border-2 border-gray-600 rounded-2xl block relative z-1 py-5">
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-10 lg:gap-10 mx-auto w-[80%] h-auto">
            <div className="col-span-3 w-[75%]  text-2xl font-bold dark:text-white">Just Some Amateur <span className="bg-gradient-to-r from-orange-500  to-yellow-300 text-transparent bg-clip-text">Web Dev</span></div>
            ...
            <div className="lg:col-span-4 connect ">
                <h1 className=" text-left lg:text-end text-2xl mb-5 font-extrabold bg-gradient-to-t from-violet-500  to-sky-500 text-transparent bg-clip-text">Connect with Me</h1>
                <div className="connect-item group ">
                    <ImMail4 className="contact-icon group-hover:text-sky-500 dark:text-white"/>
                    <a href="mailto:kheumsomnang@gmail.com" className="email group-hover:text-sky-500 dark:text-white"> E-mail</a>
                </div>
                <div className="connect-item group">
